...
const HomePage3 = () => {
  ...
  return (
    <div className="relative w-screen min-h-screen font-commissioner">
      ...
      {/* This fixed background will only be visible in the hero section. */}
      ...
      <div className="relative z-10 w-full">
        ...
        {/* Hero Section (this area is transparent, showing the fixed background) */}
        ...
        {/* Partners Section (this section has a solid white background, covering the image) */}
        ...
        {/* Who We Are Section */}
        {/* THE ONLY CHANGE IS HERE: `bg-[#E2FFEF99]` is now `bg-[#E2FFEF]` (solid color) */}
        <section className="flex flex-wrap justify-center items-start w-full bg-[#E2FFEF] py-16 px-4 lg:px-8 gap-8">
        ...
        {/* Subsequent sections with solid backgrounds */}

...
const MissionAndVision = () => {
  ...
  // useInView gives us a ref function (cardsRef) and an inView boolean
  const { ref: cardsInViewRef, inView: cardsInView } = useInView({
    triggerOnce: true,
    threshold: 0.2,
  });
  ...
  return (
    <div>
      ...
      <section className="relative min-h-screen pb-16">
        ...
        <div className="max-w-6xl px-4 md:px-20 pt-32 md:pt-40">
          ...
          <motion.h2
            ...
            className="text-[32px] md:text-[45px] font-bold leading-[40px] md:leading-[48px] text-white mb-10 max-w-2xl"
          >
          ...
          <motion.p
            ...
            className="text-[18px] md:text-[25px] leading-[28px] md:leading-[32px] font-medium text-white max-w-3xl"
          >
      ...
      <section className="relative mb-20 md:mb-32 pt-16">
        <motion.div
          // attach BOTH refs: the scrollRef (for scrolling) and the useInView ref (for animations)
          ref={(el) => {
            scrollRef.current = el;
            // cardsInViewRef can be a function ref from useInView — call it with the element
            if (typeof cardsInViewRef === "function") cardsInViewRef(el);
            else if (cardsInViewRef) cardsInViewRef.current = el; // just in case
          }}
        ...
        >
          {/* Card 1 */}
          <motion.div variants={fadeUp} className="flex-shrink-0 w-[90vw] md:w-[550px] h-auto md:h-[450px]">

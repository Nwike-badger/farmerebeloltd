...
import image4 from '../assets/Rectangle 1472.png';
    ...
    <div className="relative w-screen min-h-screen font-commissioner">
      ...
      <div className="relative z-10 w-full">
        ...
        <section className="flex flex-col items-center justify-center min-h-screen w-full text-center px-4">
          ...
          <div ref={heroRef} className={`transition-all duration-700 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          ...
          <button
            ...
            className={`w-[200px] h-[50px] bg-black text-white font-semibold text-lg md:text-[20px] rounded-[10px] mt-10 transition-all duration-700 delay-300 ease-in-out hover:bg-gray-800 hover:scale-105 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}
          >
            Discover our farm
          </button>
        </section>
        ...
        <section ref={whoWeAreRef} className="flex flex-wrap justify-center items-start w-full bg-[#E2FFEF] py-16 px-4 lg:px-8 gap-8">
          {/* MODIFIED: Add animation class based on parent's visibility */}
          <div className={`w-full lg:w-[42%] transition-all duration-500 ${whoWeAreInView ? 'animate-fade-in-right' : 'opacity-0'}`}>
            <div className="flex flex-col justify-between min-h-[500px]">
              ...
              <a href='/about/our-story' className="flex items-center justify-center w-[200px] h-[50px] bg-black text-white font-semibold text-lg md:text-[20px] rounded-[10px] mt-8 transition-transform hover:scale-105">
                Discover our farm
              </a>
            </div>
          </div>
          
          <div className={`relative w-full lg:w-[47%] mt-2 min-h-[400px] lg:min-h-[500px] flex justify-center items-center lg:items-start transition-all duration-500 delay-200 ${whoWeAreInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
            <img src={image6} alt="Lush, green palm oil plantation..." className="w-full max-w-lg lg:max-w-full h-auto lg:h-[500px] rounded-xl object-cover shadow-lg"/>
